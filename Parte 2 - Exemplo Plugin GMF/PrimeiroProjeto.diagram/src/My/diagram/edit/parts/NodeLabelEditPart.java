...
public class NodeLabelEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new My.diagram.edit.policies.MyTextSelectionEditPolicy());
	...
	*/
	protected Image getLabelIcon() {
		...
		return My.diagram.providers.MyElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = My.diagram.providers.MyParserProvider.getParser(My.diagram.providers.MyElementTypes.Node_2001,
					getParserElement(),
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					My.diagram.edit.parts.MyEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
