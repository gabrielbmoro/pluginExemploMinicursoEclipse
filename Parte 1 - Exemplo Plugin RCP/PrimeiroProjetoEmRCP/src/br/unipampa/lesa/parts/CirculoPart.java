...
import br.unipampa.lesa.Circulo;

public class CirculoPart {
	...
	public void createComposite(Composite parent) {
		...
		lblNewLabel.setBounds(127, 10, 145, 138);
		lblNewLabel.setImage(ResourceManager.getPluginImage("PrimeiroProjetoEmRCP", "icons/circuloIcone.png"));

		Label lblNewLabel_1 = new Label(parent, SWT.NONE);
		lblNewLabel_1.setBounds(10, 164, 116, 23);
		lblNewLabel_1.setText("Valor do Raio (cm):");
		...
		btnCalcularrea.addListener(SWT.MouseUp, new Listener() {
			...
			public void handleEvent(Event event) {
				try {
					double raio = Double.parseDouble(valorLado.getText());
					Circulo circulo = new Circulo(raio);
					txtResultado.setText(String.valueOf(circulo.recuperarArea()));
